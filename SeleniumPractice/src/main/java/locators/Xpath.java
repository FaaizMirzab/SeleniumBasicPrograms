...
public class Xpath {
       public static void main(String[] args) throws InterruptedException {
		...
		//by text
		//driver.findElement(By.xpath(""));// in the html code of testing application if text is present use this syntax
		x.sendKeys("its Mirzab");
		Thread.sleep(3000);
		driver.quit();
		...
		driver.quit();
		//contains
		WebElement x = driver.findElement(By.xpath("//input[contains(@type,'text')]"));
		x.sendKeys("its Mirzab");
		Thread.sleep(3000);
		driver.quit();
		*/
